...
@endsection
@section('content')
    <img src="{{asset("img/icons/home_icon.svg")}}" id="homeIconRes"><p> <span>></span> Barcelona <span>></span> <strong><a href="{{ route('home') }}" style="color: black;">Restaurantes en Barcelona</a></strong><span> > </span><strong class="roboto-bold" id="restaurant-breadcum">Bar Paco</strong></p>
    {{-- CARROUSEL --}}
    ...
    <div id="viewResContainer">
        <div class="row">
            ...
            <div class="colLikes">
                <h1 id="restaurant-score" class="scoreTextView"> <span id="totalScore" class="roboto-regular-italic"></span></h1>
                <br>
    ...
    <script>
        ...
        function displayRestaurantValorations(valorations) {
            ...
            valorations.forEach(valoration => {
                ...
                let valorationDate = dateObject.getUTCDate() + "/" + dateObject.getUTCMonth() + "/" + dateObject.getUTCFullYear();
                ...
                for (let i = 1; i <= 10; i++) {
                    if (stars == 0) {
                        valorationElement += `<img src="{{asset('img/half_star.png')}}" alt="" srcset="" class="starFilter star-empty starFilter">`;
                    } else {
                        valorationElement += `<img src="{{asset('img/half_star.png')}}" alt="" srcset="" class="starFilter star-filled starFilter">`;
                        stars--;
                    }
                }
