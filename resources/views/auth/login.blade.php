...
<body>
    <form method="POST" action="{{ route('login') }}" id="loginForm">
        ...
        <div class="row mb-3">
            <label for="email" class="col-md-4 col-form-label text-md-end roboto-black">{{ __('Email Address') }}</label>
        ...
        <div class="row mb-3">
            <label for="password" class="col-md-4 col-form-label text-md-end roboto-black">{{ __('Password') }}</label>
